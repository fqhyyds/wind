...
ap.add_argument("--output", type=str, required=True, help="path to store labelled images")
...
IMAGES_PATH = "../dataset/Nordtank_2017/"

# import the train data
print("[INFO] loading data from disk...")
data = np.load(os.path.sep.join([DATA_PATH, "train_images_17.npy"]))
labels = np.load(os.path.sep.join([DATA_PATH, "train_labels_17.npy"]))
